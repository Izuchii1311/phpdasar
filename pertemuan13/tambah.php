<?php
    ...
    if ( isset ($_POST["submit"]) ){
        ...
        // data $_POST dari form diambil oleh $data di function tambah
        if ( tambah($_POST) > 0 ) {
            echo "
                <script>
...
<html lang="en">
  ...
  <body>
    ...
    <!-- enctype untuk mengelola file di dalam form 
    maka gambar tidak akan dikelola lai oleh $_POST tetapi dikelola oleh $_FILES-->
