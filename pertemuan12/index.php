<?php
    ...
    // DESC = dari id terakhir dulu
    $mahasiswa = query("SELECT * FROM mahasiswa ORDER BY id ASC"); 

    // tombol cari di klik maka timpa $mahasiswa (SELECT * FROM mahasiswa)
    // $mahasiswa akan ditimpa dengan yg baru ketika user melakukan pencarian 
    // pencarian berdasarkan keyword yg dicari / WHERE ... LIKE

    // Atau ketika tombol cari di klik maka ganti $mahasiswa dengan function cari yang berdasarkan keyword diketikkan
    if (isset($_POST["cari"])){
          ...
          <div class="row mb-3">
            <div class="col-9">
              ...
              <div class="input-group">
                ...
                <!-- autofokus agar si inputan otomatis aktif -->
                <!-- autocomplete menghapus history dalam inputan -->
