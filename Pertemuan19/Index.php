...
<body>
    ...
    <!-- 3. Memberikan sebuah wadah (Div) dimana data nya akan berubah -->
    <!-- table id="container" -->
    <div id="container">
    ...
    <!-- 1. Include Javascript + Buat Folder baru (js) isi file dengan nama script.js-->
    <!-- Disimpan supaya di load dulu halamannya lalu jalankan scriptnya -->
