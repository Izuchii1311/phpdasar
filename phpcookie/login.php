...
<!-- Pagination adalah sebuah teknik untuk membatasi data yang tampil di halaman web kita menjadi beberapa halaman (Fitur) 

Tekniknya akan menggunakan keyword yang ada di dalam SQL yaitu LIMIT
