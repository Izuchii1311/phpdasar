<?php
    session_start();
    // 6. Cek Session Login (Jika tidak ada SESSION login maka tendang paksa ke halaman login)
...
<body>
    ...
    <!-- 8. Menambahkan atribut enctype supaya gambar dapat dikelola -->
    <form action="" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?= $dataId["id"];?>">
        <!-- 9. Jika gambar tidak diganti maka akan menggunakan gambar lama -->
        ...
        <ul>
            ...
            <li>
                ...
                <!-- 7. Menampilkan Gambar dari db -->
                <img src="img/<?= $dataId['gambar']; ?>" alt="" width="100px" height="120px">
            <li>
                <label for="gambar">Gambar      : </label>
                <!-- 2. Ubah type Inputan gambar menjadi file -->
                <!-- 6. Tidak memerlukan value -->
